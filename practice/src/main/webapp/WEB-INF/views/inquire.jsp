...
<script>
	...
	function validChk(){
		...
		var mbr_phone = form.mbr_phone2.value + form.mbr_phone3.value;
		var pdt_nm = form.pdt_nm.value;
		var pdt_no = form.pdt_no.value;
		var del_yn = form.del_yn.value;
		
		if(!mbr_nm && !bzpp_order_no && !bzpp_nm && !mbr_phone && !pdt_nm && !pdt_no){
			alert("조회할 항목을 입력해주세요!");
			form.mbr_nm.focus();
			return;
		}
...
<body>
<form name="inquire" method="post" action="inquire" enctype="multipart/form-data">
	<p>
